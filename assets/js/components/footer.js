    ...
    <footer class="site-footer" role="contentinfo">
      <div class="footer__grid">
        ...
        <div class="footer__column">
          ...
          <a href="faxshrimp.html" class="footer__link">📠 FaxShrimp™</a>
          <a href="langosta-express.html" class="footer__link">🦞 Langosta Express</a>
          <a href="soporte.html" class="footer__link">🎫 Mesa de Ayuda</a>
          <a href="rastreo.html" class="footer__link">📍 Rastreo</a>
        </div>

        <div class="footer__column">
          <h4 class="footer__column-title">Empresa</h4>
          <a href="equipo.html" class="footer__link">👥 Nuestro Equipo</a>
          <a href="crustabank.html" class="footer__link">🏦 CrustaBank</a>
          <a href="contacto.html" class="footer__link">✉️ Contacto</a>
        </div>
